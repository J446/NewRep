...
title('');
xlabel('Distance from weld centreline (mm)','Fontname','Times','FontSize',40);
ylabel({'Distance from top'; 'surface of weld (mm)'},'Fontname','Times','FontSize',40);
grid off;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%% Set Image size
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
width=30;%6*2.25;% 4inches in cm
GR=0.5*(1+(5^0.5));
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
print('-dpng','-r200',sprintf('%s%s',FILENAME,'alteredPinnacle'));
...
% h2=plot(-80,-80,'r');
% h3=plot(-80,-80,'Color',[0.5 0 0.5]);
% ax=legend([h1 h2 h3],{'Start','End','1 microsecond step'});
% LEG = findobj(ax,'type','text');
% set(LEG,'FontSize',8)
% xlim([-40 40]);
% ylim([0 .30]);
...
% %%%% Outputs figure as .png
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% print('-dpng','-r300',sprintf('%s%s',FILENAME,'alteredPinnacle'));
